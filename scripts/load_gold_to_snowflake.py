...
def load_gold_to_snowflake(**context):
    ...
    ON tgt.WINDOW_START = src.WINDOW_START
      ...
      WHEN MATCHED THEN
        ...
        WINDOW_START, ORIGIN_COUNTRY, TOTAL_FLIGHTS, AVG_VELOCITY, ON_GROUND, LOAD_TIME) VALUES 
        (src.WINDOW_START, src.ORIGIN_COUNTRY, src.TOTAL_FLIGHTS, src.AVG_VELOCITY, src.ON_GROUND, CURRENT_TIMESTAMP)
    """
